...
status: publish
published: true
title: "A Very Wicked Piece of Code: Part 3 (Happy Farm)"
author:
  display_name: 小飞熊
  login: fbbear
...
comments:
  ...
  - id: 60
    ...
    content: >-
      ...
      friends)，其他文件需要覆盖。有点困了，细节问题还没有过多的看，熊熊有空的时候会把细节问题再弄一下，大家有什么意见 and 建议也都提出来吧！</strong>
  - id: 61
    author: 呵呵
  ...
  - id: 91
    ...
    content: >-
      ...
      从错误描述上来看 应该是你把happyfarm.php放错了位置 应该放到D:\Program
  ...
  - id: 98
    ...
    content: |-
      ...
      是php程序位置放置有问题，仔细阅读下说明，bin和happyfarm目录必须为同一级才可以哦~
  - id: 99
    author: 流窜蜂
    ...
    content: >-
      TO:小飞熊  
      我比较喜欢和论坛的朋友一起玩开心农场，比如地方论坛。对PHP语言不是很懂的我试着修改你的代码，但是总是不得其所。论坛的貌似有个跳转，先转 to uc的服务器
...
![Program Run Screenshot](/assets/images/2009/03/happyfarm-demo.gif)
